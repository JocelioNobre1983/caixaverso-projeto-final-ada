		...
		do {
			...
			if (opcao == 1 || opcao == 2) {
				...
				case 1:
					...
					listaImovel.add((FinanciamentoImovel) financiamento);
					break;
				case 2:
					financiamento = new FinanciamentoAutomovel(cliente, valorBem);
					listaAutomovel.add((FinanciamentoAutomovel) financiamento);
					break;
				}
			...
			if (opcao == 3) {
				...
				for (FinanciamentoImovel f : listaImovel) {
					...
					System.out.println("Valor do imóvel: " + f.getValorBem());
					System.out.println(f.getMotivo());
				}
			}
			...
			if (opcao == 4) {
				...
				for (FinanciamentoAutomovel f : listaAutomovel) {
					System.out.println(f.getCliente());
					System.out.println("Valor do veículo: " + f.getValorBem());
					System.out.println(f.getMotivo());
				}
			}
		} while (opcao != 0);
