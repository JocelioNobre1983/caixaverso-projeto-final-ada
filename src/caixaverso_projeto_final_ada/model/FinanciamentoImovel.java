...
public class FinanciamentoImovel extends Financiamento{
	...
	public FinanciamentoImovel(Cliente cliente, double valorBem, int prestacoes) {
		super(cliente, valorBem, prestacoes);
	}

	public FinanciamentoImovel(Cliente cliente, double valorBem, int prestacoes, String motivo) {
		super(cliente, valorBem, prestacoes);
